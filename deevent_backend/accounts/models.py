...
class UserManager(BaseUserManager):
    def create_user(self, email, password=None, **extra_fields):
        ...
        # Only set is_staff=True if is_organizer=True
        if extra_fields.get('is_organizer', False):
    ...
    def create_superuser(self, email, password=None, **extra_fields):
        ...
        extra_fields.setdefault('is_organizer', True)  # Superusers are organizers by default
